...
![]({{site.baseurl | prepend: site.url}}/assets/images/700-day-streak.png){: style="width: 50%;"}
...
![]({{site.baseurl | prepend: site.url}}/assets/images/streak-society-induction.png){: style="width: 25%;"}
...
![]({{site.baseurl | prepend: site.url}}/assets/images/frozen-calendar.png){: style="width: 40%;"}
